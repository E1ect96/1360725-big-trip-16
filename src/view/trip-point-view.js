import {tripDate, tripTime, durationEvent, isPointFavorit} from '../utils';
...
export const createTripPointTemplate = (tripPoint) => {
  ...
  return `<li class="trip-events__item">
    <div class="event">
      <time class="event__date" datetime="2019-03-18">${tripDate(time.start)}</time>
      ...
      <button class="event__favorite-btn ${isPointFavorit(isFavorite)}" type="button">
